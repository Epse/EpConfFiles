...
(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/Dropbox/Documents/Org/2017.org")))
 '(org-archive-location
   (format-time-string "~/Dropbox/Documents/Org/%Y-archive.org::"
                       (current-time)))
 '(org-capture-templates
   (quote
    (("n" "A simple note" entry
      (file+headline "~/Dropbox/Documents/Org/2017.org" "INBOX")
      (file "~/Dropbox/Documents/Org/templates/note.tmpl.txt"))
     ("t" "A simple todo" entry
      (file+headline "~/Dropbox/Documents/Org/2017.org" "INBOX")
...
;;(evil-define-key 'normal web-mode-map "za" 'web-mode-fold-or-unfold)
